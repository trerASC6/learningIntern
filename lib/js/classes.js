class Intern {
    constructor(name,catagory,description,company,location,postdate,type,pay,requirements){
        this.name = name;
...
// title: Software Engineering/Data Analytics Internship
// company: Cowen
// category: Computer Scirence
// type: Full-Time
// location: New York City, New York
// post date: 07/29/2019
// pay: Compensation will be Market Rate
// description: Cowen Sustainable Investments is seeking an intern to design technology systems in ASP.NET and build web user interface. The project involves building and improving existing web user interface and web APIs. The job includes coordinating with our technology group to incorporate quantitative models into web-based user interface. 
// This role involves direct engagement with the Co-Heads of the Cowen Sustainable Investments group and technology group within Cowen. The objective is to build a range of models to analyze structured and unstructured data and sample tasks include building data gathering, data cleaning, and data analysis in both deal-specific and non-deal specific scenarios. Responsibilities also include working on web development projects to integrate the above models.
// requirements: Enrolled in an Undergraduate or Graduate Program in a quantitative field such as Computer Science, Statistics, Engineering, Applied Mathematics, or Physics. 
// Candidates with applied experience in object-oriented programming, client/server programming and statistical analysis. 
// Programming experience - Web development (Microsoft technology stack preferrred). JavaScript,SQL, Nuget or Git SVN or equivalent. Optional: ReactJS, Angular JS, Web API, Matlab 
// Strong analytical and programming skills 
// Demonstrated ability to work cooperatively with a team 
// Ability to work independently in a fast-paced enviorment 
// Execptional work ethic
...
// pay: Unpaid
// description: Analyze data sets and protoype as many experiments as necessary to converge to the optimal practical solution
...
// requirements: Pursuing a MSc/PhD in a quantitative field, such as Applied Mathematics, Computer Science, Engineering, Physics, Operations Research, Econometrics, Stochastic Finance.
...
// Excellent communication skillsVEVRAA Federal ContractorRequest Priority Protected Veteran & Disabled Referrals for all of our locations within the stateThe EEO is the Law poster is available here.FactSet Research Systems Inc. endeavors to make our website accessible to any and all users.